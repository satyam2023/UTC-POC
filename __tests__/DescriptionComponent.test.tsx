...
test('Component rendered',()=>{
    const component=renderer.create(<DescriptionCard description={'Nothing'}/>)
    expect(component.toJSON()).toMatchSnapshot();
})

test('test Description test',()=>{
    const mockFunction=jest.fn();
    const component=renderer.create(<DescriptionCard description={'Nothing'} onPress={mockFunction}/>)
